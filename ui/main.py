...
def run():
    ...
    while run_server:
        ...
        uii.ui_restart_server = False
        try:
            ui.queue().launch(inbrowser=launch_browser, server_name='127.0.0.1', server_port=server_port, share=False, ssl_verify=ssl_verify, prevent_thread_lock=True, show_error=True)
